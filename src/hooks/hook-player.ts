...
export function usePlayer(option: PropsOption) {
	...
	const reload = () => {
		client.value?.switchVideo({
			...
			pic: `https://oss.lisfes.cn/cloud/cover/2021-09/1632913648240.jpg`,
			thumbnails: `https://oss.lisfes.cn/cloud/cover/2021-09/1632913648240.jpg`
		})
		seek(0)
		play()
	}
