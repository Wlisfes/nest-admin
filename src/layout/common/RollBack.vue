    ...
    setup(props, { emit }) {
        return () => (
            <Transition name="fade" mode="out-in" appear>
                <n-el class="app-back" v-show={props.visible} onClick={() => emit('touch')}>
                    <i class="n-base-icon">
